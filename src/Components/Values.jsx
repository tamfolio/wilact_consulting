  ...
  return (
    <div className="bg-[#1E1E1E] py-[80px] flex flex-col items-center">
      ...
      <div className="flex gap-[50px] flex-wrap items-center justify-center">
        <div className="w-[350px] h-[334px] bg-[#2d2d2d] relative px-[28px] pt-[140px]">
            <img src="/assets/gradient.png" alt="" className="absolute right-0 top-0"/>
        ...
        <div className="w-[350px] h-[334px] bg-[#2d2d2d] relative px-[38px] pt-[140px]">
            <img src="/assets/gradient.png" alt="" className="absolute right-0 top-0"/>
