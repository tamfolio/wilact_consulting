...
function CoreServices() {
  return (
    <div className="w-full flex flex-col bg-white py-[50px]">
      <div className="flex flex-col items-center justify-center mb-[110px]">
        <h1 className="text-[54px] font-semibold">Core Services</h1>
        <span className="text-[24px] font-light text-[#585858]">
          Your Partner for Transformative Growth
        </span>
      </div>

      <div className="flex flex-col lg:flex-row items-start justify-center px-[100px] gap-[40px] lg:gap-[229px]">
